                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            ...
                            <?php
                                ...
                                <img src="<?= base_url($this->session->userdata(field_profile_image)) ?>" alt="avatar"  class="rounded-circle img-fluid" style="width: 30px;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="<?= base_url('administrator/settings') ?>"><i class="fa fa-cog"></i>Settings</a>
                            <!-- <a class="dropdown-item" href="javascript:;"><i class="fa fa-support"></i>Support</a> -->
                            <li class="dropdown-divider"></li>
                            <a class="dropdown-item" href="<?= base_url('administrator/logout') ?>"><i class="fa fa-power-off"></i>Logout</a>
                        </ul>
                    </li>
                </ul>
