      ...
      <div class="row align-items-center mb-4">
        ...
        <div class="col-md-4">
          <div class="d-flex align-items-center justify-content-end">
            <!-- <select class="form-control bgdarkred btnround" style="min-width: 150px" id="state">
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          for (let i = 0; i < admin.length; i++) {
            ...
            str += `<tr>
                        <td>${count}</td>
                        <td class="title">${admin[i].name}</td>
                        <td>${admin[i].email}</td>
                        <td>${admin[i].mobile}</td>
                    
                        <td><label class="switch">
                        <input type="checkbox"  ${admin_status} id = "check-status" data ="${admin[i].uid}" onclick="status(this, '${admin[i].uid}')">
