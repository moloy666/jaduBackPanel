...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Add Compliment</h5>
                    ...
                    <form id="add_data_form">
                        <div class="col">
                            ...
                            <div class="form-group mt-2">
                                <input class="form-control" type="text" placeholder="Enter Name" id='add_name' name="name" autocomplete="off">
                            </div>
    ...
    <div class="modal fade custmmodl" id="edtView1" tabindex="-1" role="dialog" aria-labelledby="edtView1Title" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Edit Compliment</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="update_form">
                        <div class="col">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="hidden" value="" placeholder="Your Name" id="edit_id" name="uid">
                                <input class="form-control" type="text" value="" placeholder="Enter Name" id="edit_name" name="name">
                            </div>
                        </div>
                    </form>
                </div>
