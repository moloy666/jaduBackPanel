                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            ...
                            <?php
                                ...
                                <img src="<?= $apiBaseUrl . $this->session->userdata(session_franchise_profile_image) ?>" alt="avatar" class="rounded-circle img-fluid">
                            <?php
                            }
                            ?>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="<?= base_url('franchise/logout') ?>"><i class="fa fa-power-off"></i>Logout</a>
                        </ul>
                    </li>
                </ul>
