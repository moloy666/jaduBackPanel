...
<body>
                    ...
                    <form id="add_data_form">
                        <div class="col">
                            ...
                            <div class="form-group mt-2">
                                <input class="form-control" type="text" placeholder="Enter Title" id='title' name="title" autocomplete="off">
                            </div>
    ...
    <div class="modal fade custmmodl" id="edtView1" tabindex="-1" role="dialog" aria-labelledby="edtView1Title" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Edit Features</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="edit_image_file" name="image_icon" onchange="loadFile(event, 'edit_image' )" style="display:none">
                                </div>
                            </div>

                            <div class="form-group">
                                <input class="form-control" type="hidden" placeholder="Your Name" id="edit_id" name="uid">
                                <input class="form-control" type="text"  placeholder="Enter Title" id="edit_title" name="title">
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" form="update_form" class="btn btn-success" id="btn_update_data">Save</button>
                </div>
            </div>
        </div>
    </div>
