        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document" width="">
            <div class="modal-content">
                ...
                <div class="d-flex justify-content-center mb-2">
                    <button type="button" class="btn btn-sm btn-secondary mr-3" data-dismiss="modal" id="close_add_modal">Close</button>
                    <button type="submit" class="btn btn-sm btn-success" id="btn_add_service">Add Service</button>
                </div>
            </div>
        </div>
    </div>
