    ...
    <div class="page-wrapper">
        ...
        <header class="header">
            <div class="page-brand">
                <a class="link" href="<?=base_url('sarathi/dashboard')?>">
                    <span class="brand">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            ...
                            if (empty($this->session->userdata(session_sarathi_profile_image) || ($this->session->userdata(session_sarathi_profile_image)) == null) || ($this->session->userdata(session_sarathi_profile_image)) == '') { ?>
                                ...
                                <img src="<?= base_url('assets/images/admin-avatar.png') ?>" alt="avatar" class="rounded-circle img-fluid" >

                            <?php
                            } else { ?>
                                <img src="<?= $apiBaseUrl . $this->session->userdata(session_sarathi_profile_image) ?>" alt="avatar" class="rounded-circle img-fluid" >
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="<?= base_url('Sarathi/logout') ?>"><i class="fa fa-power-off"></i>Logout</a>
                        </ul>
                    </li>
                </ul>
