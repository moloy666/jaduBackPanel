...
<div class="content-wrapper">
  <div class="container py-5">
    <h3 class="mb-3 ml-3 text-primary">Profile Details</h3>
        ...
        <div class="card mb-2 p-2">
          <form id="form_image">
            <div class="card-body text-center">
              <label for="image">
                <?php
                if (empty($this->session->userdata(session_hotel_image) || ($this->session->userdata(session_hotel_image)) == null) || ($this->session->userdata(session_hotel_image)) == '') { ?>

                  <img src="<?= base_url('assets/images/admin-avatar.png') ?>" alt="avatar" id="output" class="rounded-circle img-fluid" style="width: 100px;">

                <?php
                } else { ?>
                  <img src="<?= base_url($this->session->userdata(session_hotel_image)) ?>" alt="avatar" id="output" class="rounded-circle img-fluid" style="width: 100px;">
              ...
              <input type="hidden" value="<?= $this->session->userdata(session_hotel_id) ?>" id="specific_id">
        ...
        <div class="card mb-6">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0 title" id="txt_name"></p>
            ...
            <div class="row float-right mr-2">
              <button class="btn btn-primary" id="edit_btn" style="display:none">Edit</button>
              <button class="btn btn-primary" id="update_btn" style="display:none">Update</button>
      ...
      <!-- <div class="col-lg-4">
        <div class="card mb-6">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-sm-3">
                <p class="mb-0">City / Location</p>
              </div>
              <div class="col-sm-9">
                <p class="text-muted mb-0" id="txt_location"></p>
                <input type="text" id="location" class="form-control txtbox" placeholder="City / Location">
              </div>
            </div>
            <hr>
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0" id="txt_pincode"></p>
                <input type="text" id="pincode" class="form-control txtbox" placeholder="PinCode">
              </div>
            </div>
            <hr>
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                ...
                <input type="text" id="dob" class="form-control txtbox" placeholder="City / Location">
              </div>
            </div>
            <hr>
