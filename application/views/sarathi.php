            ...
            $.each(sarathi, function(i, data) {
              ...
              str += `<tr>
                        ...
                        <td class="nowrap">
                          ...
                          <button class="hdrbtn mx-2 access_update" data-toggle="modal" id="editbtn"  data-target="#edtView1"  onclick="edit_sarathi('${sarathi[i].user_id}' , '${sarathi[i].name}' , '${sarathi[i].email}' , '${sarathi[i].mobile}')" disabled>
                          ...
                          <button class="hdrbtn delete_sub_franchise access_delete" data-toggle="modal" data="${sarathi[i].user_id}" data-target="#deltmodl" disabled>
