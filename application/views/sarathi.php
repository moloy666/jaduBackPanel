...
<body>
  ...
  <script>
        ...
        success: function(response) {
          ...
          if (response.success) {
            ...
            $.each(sarathi, function(i, data) {
              ...
              str += `<tr>
                        <td>${count}</td>
                        <td class="title nowrap"><a href="<?= base_url("administrator/saathi_details/") ?>${sarathi[i].user_id}">${sarathi[i].name}</a>
                        <span id="${sarathi[i].user_id}"></span>
                        </td>
                        <td>${sarathi[i].email}</td>
                        <td>${sarathi[i].mobile}</td>
                        <td>${sarathi[i].refferal_code}</td>
                        <td class="title nowrap">${sarathi[i].subfranchise.name}</td>
                        ...
                        <td class="nowrap">
                          ...
                          <button class="hdrbtn mx-2" data-toggle="tooltip" data-placement="top" title="View Document" onclick="view_document('${sarathi[i].user_id}')">
                              <img src="<?= base_url('assets/images/view_document.png') ?>" alt="" width="20px" class="mb-3">     
                          </button> 

                          <button class="hdrbtn mx-2 access_update" data-toggle="modal" id="editbtn"  data-target="#edtView1"  onclick="edit_sarathi('${sarathi[i].user_id}' , '${sarathi[i].name}' , '${sarathi[i].email}' , '${sarathi[i].mobile}')" data-toggle="tooltip" data-placement="top" title="Edit" disabled>
                          ...
                          <button class="hdrbtn delete_sub_franchise access_delete" data-toggle="modal" data="${sarathi[i].user_id}" data-target="#deltmodl" data-toggle="tooltip" data-placement="top" title="Delete" disabled>
    ...
    function view_document(user_id) {
      location.href = `<?= base_url('administrator/saathi/document/') ?>${user_id}`;
    }
